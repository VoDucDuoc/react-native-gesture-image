...
const ImageViewer = ({
  ...
  const imageAnimatedStyle = useMemo(
    () => [
      ...
      {
        width: SCREEN_WIDTH,
        // Prevent NaN/Infinity before imageDimensions are known
        // When width is 0 initially, (SCREEN_WIDTH * h) / 0 => NaN which crashes native bridge
        height:
...
export type { GalleryProps, GalleryRef, ImageViewerProps };
